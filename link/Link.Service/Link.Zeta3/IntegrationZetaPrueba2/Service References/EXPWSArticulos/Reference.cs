...
namespace IntegrationZetaPrueba2.EXPWSArticulos {
    ...
    public interface ExpWSArticulosSoapPort {
        ...
        IntegrationZetaPrueba2.EXPWSArticulos.ExecuteResponse Execute(IntegrationZetaPrueba2.EXPWSArticulos.ExecuteRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="LIBRAaction/AEXPWSARTICULOS.Execute", ReplyAction="*")]
        System.Threading.Tasks.Task<IntegrationZetaPrueba2.EXPWSArticulos.ExecuteResponse> ExecuteAsync(IntegrationZetaPrueba2.EXPWSArticulos.ExecuteRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ExpWSArticulosSoapPortChannel : IntegrationZetaPrueba2.EXPWSArticulos.ExpWSArticulosSoapPort, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ExpWSArticulosSoapPortClient : System.ServiceModel.ClientBase<IntegrationZetaPrueba2.EXPWSArticulos.ExpWSArticulosSoapPort>, IntegrationZetaPrueba2.EXPWSArticulos.ExpWSArticulosSoapPort {
        ...
        IntegrationZetaPrueba2.EXPWSArticulos.ExecuteResponse IntegrationZetaPrueba2.EXPWSArticulos.ExpWSArticulosSoapPort.Execute(IntegrationZetaPrueba2.EXPWSArticulos.ExecuteRequest request) {
        ...
        public sbyte Execute(string Empid, string Emppassword, string Codigo, int Inciar, int Cantidad, string Fechaini, string Fechafin, out string Error, out IntegrationZetaPrueba2.EXPWSArticulos.ArticulosSDTArticuloItem[] Articulos) {
            IntegrationZetaPrueba2.EXPWSArticulos.ExecuteRequest inValue = new IntegrationZetaPrueba2.EXPWSArticulos.ExecuteRequest();
            inValue.Empid = Empid;
            ...
            IntegrationZetaPrueba2.EXPWSArticulos.ExecuteResponse retVal = ((IntegrationZetaPrueba2.EXPWSArticulos.ExpWSArticulosSoapPort)(this)).Execute(inValue);
            Error = retVal.Error;
            Articulos = retVal.Articulos;
            return retVal.Ok;
        }
        
        public System.Threading.Tasks.Task<IntegrationZetaPrueba2.EXPWSArticulos.ExecuteResponse> ExecuteAsync(IntegrationZetaPrueba2.EXPWSArticulos.ExecuteRequest request) {
